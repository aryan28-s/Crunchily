...
const HeroSection = () => {
    return (
        <div className="hero-section text-center py-5 bg-dark text-black"><br></br><br></br><br></br><br></br>
            <p className="display-4 my-custom-text"style={{color:"skyblue", background:"transparent",width:"800px","font-size":"50px","border-radius":"10px 0px 0px 10px",position:"absolute",right:"0px",top:"180px"}}><i>a2r4y1a7n9s2h5i8n4d2e8282@9g2m5a0i2l9.2c0o3m4</i></p>
